...
int test_remw () {
	...
	CHECK_IS(remw ,  int64_t, 0x000000007fffffff, 0x7fffffff, 0x80000000)
...
int test_remuw () {
    ...
    CHECK_IS(remuw,  int64_t, 0                 , 0x0       , 0x0       )
	CHECK_IS(remuw,  int64_t, 0                 , 0x0       , 0x1       )
	CHECK_IS(remuw,  int64_t, 0                 , 0x0       , -0x1      )
	CHECK_IS(remuw,  int64_t, 0                 , 0x0       , 0x7fffffff)
	CHECK_IS(remuw,  int64_t, 0                 , 0x0       , 0x80000000)

	CHECK_IS(remuw,  int64_t, 0x0000000000000001, 0x1       , 0x0       )
	CHECK_IS(remuw,  int64_t, 0                 , 0x1       , 0x1       )
	CHECK_IS(remuw,  int64_t, 0x0000000000000001, 0x1       , -0x1      )
	CHECK_IS(remuw,  int64_t, 0x0000000000000001, 0x1       , 0x7fffffff)
	CHECK_IS(remuw,  int64_t, 0x0000000000000001, 0x1       , 0x80000000)

	CHECK_IS(remuw,  int64_t, 0xffffffffffffffff, -0x1      , 0x0       )
	CHECK_IS(remuw,  int64_t, 0                 , -0x1      , 0x1       )
	CHECK_IS(remuw,  int64_t, 0                 , -0x1      , -0x1      )
	CHECK_IS(remuw,  int64_t, 0x0000000000000001, -0x1      , 0x7fffffff)
	CHECK_IS(remuw,  int64_t, 0x000000007fffffff, -0x1      , 0x80000000)

	CHECK_IS(remuw,  int64_t, 0x000000007fffffff, 0x7fffffff, 0x0       )
	CHECK_IS(remuw,  int64_t, 0                 , 0x7fffffff , 0x1      )
	CHECK_IS(remuw,  int64_t, 0x000000007fffffff, 0x7fffffff, -0x1      )
	CHECK_IS(remuw,  int64_t, 0                 , 0x7fffffff, 0x7fffffff)
	CHECK_IS(remuw,  int64_t, 0x000000007fffffff, 0x7fffffff, 0x80000000)

	CHECK_IS(remuw,  int64_t, 0xffffffff80000000, 0x80000000, 0x0       )
	CHECK_IS(remuw,  int64_t, 0                 , 0x80000000, 0x1       )
	CHECK_IS(remuw,  int64_t, 0xffffffff80000000, 0x80000000, -0x1      )
	CHECK_IS(remuw,  int64_t, 0x0000000000000001, 0x80000000, 0x7fffffff)
	CHECK_IS(remuw,  int64_t, 0                 , 0x80000000, 0x80000000)
